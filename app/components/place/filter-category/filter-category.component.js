...
angular.module('filterCategory', ['ngResource'])
  .component('filterCategory', {
    ...
    controller: function FilterCategoryController($http, $rootScope, placeModel, placesOnMap, $scope) {
      var self = this;
      var j; // counters
      var firstCheck = true; // variable for first check onload
      $rootScope.type = 'Featured_Place';
      var pointsTypeForShowOnLoad = $rootScope.type;
      var arrPlaces = [];
